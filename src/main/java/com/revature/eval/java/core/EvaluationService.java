...
public class EvaluationService {
	...
	static class SpeedConverter {
		...
		public static String printConversion(double kilometersPerHour) {
				...
				String statement = kilometersPerHour+ " km/h = "+ conversion+" mi/h";
	...
	public String printMegaBytesAndKiloBytes(int XX) {
		...
		conversion = ((XX)/1024);
		remaining = ((XX)%(1024));
		String statement = XX + " KB = " + conversion+ " MB and " + remaining +" KB";
	...
	if(hourOfDay<8 || hourOfDay>22 && isBarking==true) {
	...
	static class Triangle {
		...
		public boolean isEquilateral() {
				...
				if(sideOne==sideTwo&&sideOne==sideThree&&sideTwo==sideThree&&sideThree==sideTwo) {
